...
import { useSegmentation, useWorkspace } from "../../context/AppContext";
...
const ServiceControlGrid = ({
  ...
  useBgRemovalPostProcessor(
    serviceId === "background-removal" ? options : null,
    serviceId === "background-removal" ? sourceCanvas : null,
    serviceId === "background-removal" ? resultCanvas : null,
  );
